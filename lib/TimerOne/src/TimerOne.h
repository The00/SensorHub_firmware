...
class TimerOne
{
  ...
  public:
    ...
    void setPwmDuty_micros(char pin, unsigned long duty_micros) __attribute__((always_inline))
    {
    //unsigned long duty= (duty_micros<<10)/period_micros;
    setPwmDuty(pin, ((duty_micros<<10)/pwmPeriod));
    }
